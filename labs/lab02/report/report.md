...
Перехоидм к настройке каталога курса. Заходим в наш новый каталог "os-intro"  и удаляем лишние файлы, создаем необходимые каталоги  (рис. [-@fig:013]) и отправляем файлы на сервер  (рис. [-@fig:014]), (рис. [-@fig:015], (рис. [-@fig:016])).
